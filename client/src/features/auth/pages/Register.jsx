        ...
        <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-2xl shadow-2xl shadow-black/40 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-2.5 px-4 rounded-lg font-semibold text-sm text-white bg-[#31b8c6] hover:bg-[#29a0ac] disabled:bg-gray-600 disabled:cursor-not-allowed shadow-lg shadow-[#31b8c6]/30 hover:shadow-[#31b8c6]/50 active:scale-[0.98] transition-all duration-200 cursor-pointer"
            >
